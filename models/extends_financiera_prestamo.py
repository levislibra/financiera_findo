...
class ExtendsFinancieraPrestamo(models.Model):
	...
	def pre_requisitos_solicitud_portal(self, partner_id):
		if not partner_id.perfil_vio_pass:
			raise UserError("Desde Mi Perfil debe:\n* Completar perfil VIO.")
		super(ExtendsFinancieraPrestamo, self).pre_requisitos_solicitud_portal(partner_id)
